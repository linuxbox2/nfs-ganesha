...
static void *proxy_memmgr(void *parent, void *child)
{
...
/**
 * @brief Manage the attachment of the child into the parent
 *
...
static void proxy_attach(void *parent, void *child)
{
	return;
}
...
static struct config_item proxy_params[] = {
	...
	CONF_ITEM_BLOCK("remote_server", proxy_memmgr,
			proxy_client_params, proxy_attach),
	CONFIG_EOL
};
