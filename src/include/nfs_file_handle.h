 ...
 * @brief Structure of the filehandle and prototypes to use it
 */
...
typedef struct file_handle_v2
{
  ...
  uint8_t xattr_pos; /*< Used for xattr management.  Will be marked
		         'reserved' and set to 0 after v2.1 xattrs
		         changes. */
...
{
  uint8_t fhversion; /*< Set to 0x41 to separate from Linux knfsd */
  uint8_t xattr_pos; /*< Index for named attribute handles.  This
		         will be marked 'reserved' and set to 0 after
		         v2.1 xattr changes. */
  uint16_t exportid; /*< Must be correlated to exportlist_t::id */
  uint8_t flags; /*< Special handling for the filehandle. */
...
/**
 * @{
 * @brief NFSv4 Handle Flags
 */

/** Vanilla handle */
static const uint8_t V4_HANDLE_NONE = 0x0;
/** A pNFS DS handle, generated by a Ganesha MDS and meant to be
    handled by Ganesha. */
static const uint8_t V4_HANDLE_DS = 0x1;
