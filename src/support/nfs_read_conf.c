...
static struct config_item core_params[] = {
	...
	CONF_ITEM_UI32("DRC_TCP_Npart", 1, 19, DRC_TCP_NPART,
		       nfs_core_param, drc.tcp.npart),
	CONF_ITEM_UI32("DRC_TCP_Nlane", 1, 19, DRC_TCP_NLANE,
		       nfs_core_param, drc.tcp.nlane),
	...
	CONF_ITEM_UI32("DRC_UDP_Npart", 1, 97, DRC_UDP_NPART,
		       nfs_core_param, drc.udp.npart),
	CONF_ITEM_UI32("DRC_UDP_Nlane", 1, 97, DRC_UDP_NLANE,
		       nfs_core_param, drc.udp.nlane),
